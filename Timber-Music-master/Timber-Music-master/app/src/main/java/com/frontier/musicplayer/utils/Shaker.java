        ...
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if ((curTime - mLastShakeTime) > MIN_TIME_BETWEEN_SHAKES_MILLISECS) {
                ...
                if(threshold.equals("high"))
                    ...
                    SHAKE_THRESHOLD = 10f; // Adjusted low to 5f which was earlier 15f
                else
                    SHAKE_THRESHOLD = 15f; // Adjusted to 10f which was earlier 25f (value never reaches no matter how hard you shake)
